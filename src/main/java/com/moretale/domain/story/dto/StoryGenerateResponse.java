...
@Schema(description = "동화 생성 결과 응답 DTO (저장 전 임시 상태)")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class StoryGenerateResponse {
    ...
    @Schema(description = "생성된 슬라이드 목록")
    ...
    public static class GeneratedSlide {
        ...
        @Schema(description = "슬라이드 순서 (생성 결과 기준, 1부터 시작)", example = "1")
        ...
        @Schema(description = "한국어 음성 URL (TTS 생성 후 채워짐)", example = "https://storage.example.com/audio/slide1_kr.mp3")
        private String audioUrlKr;

        @Schema(description = "제2언어 음성 URL (TTS 생성 후 채워짐)", example = "https://storage.example.com/audio/slide1_vi.mp3")
